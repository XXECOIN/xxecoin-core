...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "XXEcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    ...
    {"xxecoinnode.my.id", "node1.xxecoinnode.my.id"},
    {"xxecoinnode.my.id", "node2.xxecoinnode.my.id"},
    {"xxecoinnode.my.id", "node3.xxecoinnode.my.id"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. XXEcoin is probably already running."), addrBind.ToString().c_str());
        else
